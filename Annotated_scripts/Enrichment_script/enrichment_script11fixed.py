...
# Base directory paths for your data
base_path = '/home/sp877/Independent_project/enchrichment_count/ASMV_output_noumi'

# Function to read and process the dataset, handling errors in lines
...
def calculate_ratios(data, max_mutations):
    # Creates an empty dictionary to store the mutation dat
    mutation_data = {}
    ...
    # Sum the ratios for each mutation if there are multiple occurrences
